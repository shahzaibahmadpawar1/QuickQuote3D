    ...
    <header className="pointer-events-none fixed inset-x-0 top-2 z-50 px-4 pt-2 sm:px-6">
      <div className="landing-nav-pill pointer-events-auto mx-auto flex h-14 w-full max-w-[960px] items-center justify-between gap-3 px-4 sm:px-5">
        ...
        <div className="flex shrink-0 items-center gap-1 sm:gap-2">
          ...
          <Link
            href={primaryHref}
            className="inline-flex h-9 cursor-pointer items-center justify-center rounded-full bg-gradient-accent px-4 text-sm font-semibold text-primary-foreground shadow-[0_8px_24px_-10px_rgba(124,134,84,0.45)] transition-transform duration-200 hover:scale-[1.03] sm:h-10 sm:px-5"
          >
            {primaryLabel}
          </Link>
        </div>
